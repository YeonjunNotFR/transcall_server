...
interface JanusPluginService {
    suspend fun attachPlugin(session: WebSocketSession, sessionId: Long, plugin: com.youhajun.transcall.janus.dto.plugin.JanusPlugin): Result<AttachData>

    suspend fun attachManagerPlugin(sessionId: Long, plugin: com.youhajun.transcall.janus.dto.plugin.JanusPlugin): Result<AttachData>
